...
export default function Skills(){
  ...
  return (
    <section id="skills"
      ref={sectionRef}
      className="h-1/2 w-full pb-8 flex flex-col justify-center items-center relative bg-black text-white overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-0-1/4 right-0 w-75 h-75 rounded-full bg-linear-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8d2]
        ...
        <motion.p 
          className="pt-2 mb-8 text-white/90 text-base md:text-lg z-10"
          ...
          <motion.div 
            ...
            >
              {repeated.map((s, i) => (
                <div 
                  key={i}
                  className="flex flex-col items-center gap-2 min-w-30 pt-2"
                  aria-label={s.name}
                  title={s.name}
                >
