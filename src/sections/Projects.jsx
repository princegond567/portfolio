  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center">
              ...
              <AnimatePresence mode="wait">
                {activeIndex === idx && (
                  <motion.h3
                    ...
                    className={`block text-center text-[clamp(2rem,6vw,5rem)] text-white/95 sm:absolute sm:-top-20 
                      sm:left-[35%] sm:mb-0 lg:left-[-5%] italic font-semibold ${isMobile ? "-mt-24" : ""}`}
        ...
        <div className={`absolute ${isMobile ? "bottom-10" : "bottom-7"}`}>
