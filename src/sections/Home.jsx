        ...
        <div className='relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2'>
          <div className='flex flex-col justify-center h-full text-center lg:text-left relative'>
            <div className='w-full lg:pr-24 mx-auto max-w-3xl'>
              ...
              >
                I turn complex ideas into seamless, high-impact web experience - building modern, scalable, and lightning-fast applications that make a difference.
              </motion.p>
              ...
              <motion.div className='mt-10 flex flex-wrap items-center justify-center lg:justify-start gap-6'>
                ...
                className='px-6 py-3 rounded-full font-medium text-lg text-black bg-white
                 transition-all hover:bg-gray-200 shadow-lg hover:scale-105'
                >
                  My Resume
                </a>
              </motion.div>
          ...
          <div className='relative hidden lg:block'>
            ...
            <motion.img src={avator} alt='Prince Gond'
