...
import { div, label, section } from "framer-motion/client";
...
export default function About(){
  ...
  const glows = [
    "-top-10 -left-10 w-[360px] h-[360px] opacity-10 blur-[120px]",
  ...
  return (
    <section id="about"
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          <motion.div className="relative w-40 h-40 md:w-50 md:h-50 rounded-2xl overflow-hidden shadow-2xl bg-linear-to-r form-[#1cd8d2]/20 to-[#302b63]/20 border border-[#1cd8d2]/25"
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I build scalable, modern appications with strong focus on clean architecture, delightful UX, and performance. My toolkit spans java,
              React, Next.js, TypeScript, Tailwind CSS, and RestfulAPI - bringing idea to life from concept to production with robust APIs and smooth interfaces.
            </p>
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 max-w-xl gap-3 sm:gap-4">
              {stats.map((item, i) => (
        ...
        <motion.div className="text-center md:text-left"
          ...
          viewport={{once: true, amount: 0.4}}
        >
          <h3 className="text-2xl sm:text-3xl leading-relaxed font-bold text-white mb-3">About Me</h3>
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">I am a Software Developer and Web Developer - passionate about buildng fast, resilient applications and sharing coding insights on Instagram and Youtube.</p>
