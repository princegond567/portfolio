...
export default function Contact(){
  ...
  const validateForm = () => {
    ...
    const newErrors = {};
    required.forEach((f) => !formData[f].trim() && (newErrors[f] = "Fill the field"));
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <option value="App Develpoment"  className="text-black">
                    App Development
                  </option>
              ...
              <div className="flex flex-col">
                <label className="mb-1">Explian Your Idea <span className="text-red-500">*</span></label>
                <textarea name="idea"
                  rows={5}
              ...
              {status && (
                <p className={`text-sm ${status === "success" ? "text-green-400" : status === "error" ? "text-red-400" : "text-yellow-400"}`}>
                  {status === "sending" ? "sending..." : status === "success" ? "Messege sent successfully ✅" : "Something went wrong ❌"}
                </p>
              )}
              ...
              <motion.button className="bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white py-3 rounded-md font-semibold transition"
                ...
                type="submit"
              >
                {status === "sending" ? "sending..." : "Send Messege"}
              </motion.button>
