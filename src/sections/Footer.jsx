...
const socials = [
  {Icon: FaXTwitter, label: "X", href: "https://x.com/princegond567"},
  {Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/princegond567/"},
  {Icon: FaGithub, label: "GitHub", href: "https://github.com/princegond567"}
]
...
export default function Footer(){
  return (
    <footer className="relative overflow-hidden bg-black">
      ...
      <motion.div className="relative z-10 px-4 sm:px-8 lg:px-10 py:16 sm:py-20 flex flex-col items-center text-center space-y-6"
      ...
      >
        ...
        <div 
          className="h-0.75 w-24  md:w-32 rounded-full bg-linear-to-r from-[#0d58cc] via-cyan-300 to-emerald-400"
        />
        ...
        <p className="text-xs  text-gray-400">
          &copy; {new Date().getFullYear()} Prince Gond All rights reserved.
        </p>
